...
function InicioTab({ user, onOpenAuth }) {
  return (
    <div style={{
      padding: "25px",
      background: "rgba(15,23,42,0.6)",
      ...
      {/* BOTONES DE AUTENTICACIÓN EN EL CENTRO */}
      {!user && (
        <div style={{
          background: "rgba(56,189,248,0.05)",
          border: "1px solid rgba(56,189,248,0.2)",
          ...
          <div style={{
            ...
            Al crear una cuenta podrás reportar incidentes, guardar tus rutas favoritas 
            y recibir notificaciones personalizadas. <strong>¡Es completamente opcional!</strong>
          </div>
          ...
          <div style={{
            ...
            💡 Puedes explorar toda la web sin crear cuenta
          </div>
        </div>
      )}
      ...
      {user && (
        <div style={{
          ...
          <div style={{
            ...
            ✅ Bienvenido de vuelta, <strong>{user.username || user.email}</strong>
          </div>
          <div style={{
            fontSize: "13px",
            color: "rgba(255,255,255,0.6)",
            ...
            Ahora puedes reportar incidentes y usar todas las funciones premium
          </div>
        </div>
      )}
    </div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {!user && " Todos pueden ver esta información sin necesidad de crear cuenta."}
      </div>
      
      {/* Aquí va tu contenido de tráfico existente */}
      <div style={{
        marginTop: "20px",
        padding: "15px",
        background: "rgba(34,197,94,0.1)",
...
function ReporteTab({ user, onRequestLogin }) {
  ...
  const handleReportar = () => {
    if (!user) {
      ...
      alert("Formulario de reporte (implementar)");
    }
  };
    ...
    <div style={{
      ...
      {showLoginPrompt && !user ? (
        <div style={{
          ...
          <div style={{
            ...
            🔐 Inicia sesión para reportar incidentes
          </div>
          <div style={{
            fontSize: "14px",
            color: "rgba(255,255,255,0.7)",
            ...
            Para mantener la calidad de los reportes y evitar spam, necesitas crear 
            una cuenta verificada. ¡Solo toma 2 minutos!
          </div>
          <div style={{ display: "flex", gap: "10px" }}>
            ...
            <button
              onClick={() => onRequestLogin("register")}
              style={{
                padding: "10px 20px",
        ...
        <div style={{
          ...
          <div style={{
            ...
            ✅ Estás autenticado. Puedes reportar incidentes.
          </div>
        </div>
      ) : null}
      ...
      <button
        ...
        style={{
          ...
          fontFamily: "'DM Sans', sans-serif",
          boxShadow: user ? "0 4px 12px rgba(56,189,248,0.3)" : "none"
        }}
      >
        {user ? "📝 Crear Reporte" : "🔒 Reportar (Requiere cuenta)"}
      </button>
      ...
      <div style={{
        ...
        💡 Puedes navegar toda la web sin crear cuenta. Solo necesitas autenticarte 
        para reportar incidentes y usar funciones avanzadas.
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* HEADER CON AUTENTICACIÓN OPCIONAL */}
        <div style={{
          ...
          {/* Indicador de usuario autenticado (solo si hay sesión) */}
          {user && (
            <div style={{
              display: "flex",
              alignItems: "center",
        ...
        {active === "inicio" && <InicioTab user={user} onOpenAuth={setAuthModal} />}
        {active === "trafico" && <TraficoTab user={user} />}
        {active === "reporte" && <ReporteTab user={user} onRequestLogin={handleRequestLogin} />}
