  ...
  return (
    <div style={{ borderBottom:"1px solid rgba(255,255,255,0.08)", background:"rgba(10,22,50,0.6)", position:"relative", overflow:"hidden" }}>
      ...
      <div key={current} style={{ animation:"slideInFromRight 0.5s ease", padding:"0" }}>
        {a.imagen_url && (
          <img src={a.imagen_url} alt={a.titulo} style={{ width:"100%", height:"auto", maxHeight: isMobile ? "140px" : "240px", objectFit:"cover", objectPosition:"center", display:"block", background:"transparent" }} onError={e=>e.target.style.display="none"} />
        )}
