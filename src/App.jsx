...
// Placeholder para tabs (mantén tus componentes originales)
function InicioTab() {
  return <div style={{ padding: "20px", color: "#fff" }}>Contenido de Inicio</div>;
}

function TraficoTab() {
  return <div style={{ padding: "20px", color: "#fff" }}>Contenido de Tráfico</div>;
}

function ReporteTab() {
  return <div style={{ padding: "20px", color: "#fff" }}>Contenido de Reportes</div>;
}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {active === "trafico" && <TraficoTab />}
        {active === "reporte" && <ReporteTab />}
