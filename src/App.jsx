// ═══════════════════════════════════════════════════════════════════════════════
// COMPONENTE COMPLETO: AuthModal
// Sistema de Autenticación para Conect Manzanillo
// ═══════════════════════════════════════════════════════════════════════════════
//
// INSTRUCCIONES:
// Inserta este código COMPLETO en tu App.jsx DESPUÉS de FloatingAuthButton
// y ANTES de function NavBar (aproximadamente línea 590-620)
//
// ═══════════════════════════════════════════════════════════════════════════════

function AuthModal({ onClose, onLogin }) {
  const [view, setView] = useState('menu'); // menu, login, register, forgot
  const [step, setStep] = useState(1); // Para el proceso de registro (1-6)
  ...
  // Generar pregunta de captcha cuando llega al paso 6
  useEffect(() => {
    ...
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
        ...
        <div>
          ...
          >
            <option value="México" style={{background: '#1a1a1a'}}>México</option>
            <option value="Estados Unidos" style={{background: '#1a1a1a'}}>Estados Unidos</option>
            <option value="Colombia" style={{background: '#1a1a1a'}}>Colombia</option>
            <option value="Argentina" style={{background: '#1a1a1a'}}>Argentina</option>
            <option value="España" style={{background: '#1a1a1a'}}>España</option>
          </select>
        </div>
